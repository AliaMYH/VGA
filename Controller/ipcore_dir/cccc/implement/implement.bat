...
xst -ifn xst.scr
move cccc_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\cccc_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc cccc_exdes.ucf cccc_exdes

echo 'Running map'
map -timing -pr b cccc_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm cccc_exdes -w routed.ncd routed.v
cd ..
